import WinterSmartCasual from "../src/Homepage/WinterSmartCasuals/WinterSmartCasual";
...
const products = {
  ...
  Walimah: [
    {
      ...
      description: "An ice blue heavily embellished long dress with a trail, featuring intricate silver zardozi and a stunning combination of thread work Trail Maxi",
      disclaimer : "DISCLAIMER : Colors may vary due to lightening effects",
      pieces : "dupatta,Trouser",
    },
  ],
  ...
  SizeChart : ["https://firebasestorage.googleapis.com/v0/b/devrex-628fe.appspot.com/o/Pindis%2FSizechart.png?alt=media&token=eec8ae7f-dd6b-4223-821c-34ff893284db"],
};
